...
In Table \ref{did_beliefs_main}, I show changes in teachers stated beliefs about FPE following the reform.


\begingroup
\setlength{\tabcolsep}{28pt}  % Increase space between columns
\begin{table}[H]
   \begin{singlespace}
    \centering
    ...
    \begin{threeparttable}
        \input{02_tables/did_beliefs_main}
        \begin{tablenotes}
